...
export default function ClerkAuthPreview() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      console.log(values)
      toast.success('Clerk-ready auth submitted successfully. (Simulated)')
    } catch (error) {
    ...
    <div className="flex min-h-[50vh] h-full w-full items-center justify-center px-4">
      <Card className="mx-auto max-w-sm">
        <CardHeader>
          ...
          <CardTitle className="text-2xl mt-2">Sign in to your account</CardTitle>
          <CardDescription>
            Structured for Clerk Elements with social and email sign-in actions.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
