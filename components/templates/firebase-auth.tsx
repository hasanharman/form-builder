...
export default function FirebaseAuthPreview() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      console.log(values)
      toast.success('Firebase-ready auth submitted successfully. (Simulated)')
    } catch (error) {
    ...
    <div className="flex min-h-[50vh] h-full w-full items-center justify-center px-4">
      <Card className="mx-auto max-w-sm">
        <CardHeader>
          ...
          <CardDescription>
            Optimized for Firebase Authentication email/password and providers.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
