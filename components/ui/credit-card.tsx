    ...
    return (
      <div ref={ref} className={cn('w-full max-w-md mx-auto', className)}>
        <div className="relative h-56 mb-6 perspective-1000">
          ...
          >
            <Card className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 text-white p-6 flex flex-col justify-between backface-hidden">
            ...
            <Card className="absolute inset-0 w-full h-full bg-gradient-to-br from-gray-700 to-gray-900 text-white p-6 flex flex-col justify-between backface-hidden rotate-y-180">
